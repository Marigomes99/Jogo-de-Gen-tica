...
public class Jogo {
    ...
    public void iniciar() {
        ...
        while (true) {
            String input = JOptionPane.showInputDialog("Digite o número de jogadores:");

            if (input == null) {
                // Caso o usuário cancele a entrada
                JOptionPane.showMessageDialog(null, "O jogo foi cancelado.");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Erro: Por favor, insira um número válido de jogadores.");
            }
        }
    ...
    private void exibirPergunta(Pergunta pergunta) {
        String respostaUsuario = (String) JOptionPane.showInputDialog(
                null,
                pergunta.getTexto(),  // Altera para getTexto() para acessar a pergunta corretamente
                "Pergunta",
        ...
        // Verifica se o usuário cancelou a pergunta
        if (respostaUsuario == null) {
            JOptionPane.showMessageDialog(null, "Você não respondeu a pergunta.");
            return; // Retorna sem fazer mais nada se o usuário não respondeu
        }

        if (respostaUsuario.equals(pergunta.getRespostaCorreta())) {
            pontuacao++;
